...
const reactions = ["<a:emoji_29:695169244991586364>" , "😈" , "👤" , "💰" , "🎉" , "😵" , "🔱"]; // For custom emojis, provide the name of the emoji
...
function generateMessages() {
    let messages = [];
    for (const role of roles) messages.push({ role, message: `react with ${reaction} To get a ${role}` }); //DONT CHANGE THIS
    return messages;
}
