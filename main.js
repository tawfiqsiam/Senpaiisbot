...
bot.on("message", message => {
    if (if(!message.member.hasPermission('ADMINISTRATOR')) return    message.channel.send('**You Dont Have** `ADMINISTRATOR` **premission**') && message.content.toLowerCase() == setupCMD) {
